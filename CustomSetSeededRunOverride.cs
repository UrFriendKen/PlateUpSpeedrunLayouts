...
namespace KitchenSpeedrunLayouts
{
    ...
    public class CustomSetSeededRunOverride : FranchiseSystem, IModSystem
    {
        ...
        protected override void OnUpdate()
        {
            ...
            else if (Main.PrefManager.Get<int>(Main.SELECTED_LAYOUT_PROFILE_ID) != 0 && !AssetReference.FixedRunLayout.Contains(Main.PrefManager.Get<int>(Main.SELECTED_LAYOUT_PROFILE_ID)))
                valid_layouts = new int[] { Main.PrefManager.Get<int>(Main.SELECTED_LAYOUT_PROFILE_ID) };
